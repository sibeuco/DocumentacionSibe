...
| **Fuente**            | Paquetes `infraestructura.adaptador.entidad`, `dominio.dto`, `SIBEFrontend/src/app/shared/model` |
| **Versión**           | 1.0                                                                                |
...
```mermaid
erDiagram
    direccion ||--o{ area : "1:N (direccion_id)"
    direccion }o--o{ actividad : "N:M (direccion_actividad)"
    area ||--o{ subarea : "1:N (area_id)"
    area }o--o{ actividad : "N:M (area_actividad)"
    subarea }o--o{ actividad : "N:M (subarea_actividad)"
    ...
    participante }o--|| miembro : "N:1 (miembro)"
    ...
    usuario_organizacion }o--|| usuario : "N:1 (usuario)"
    usuario_organizacion }o--o| direccion : "N:1 (direccion_id)"
    ...
    indicador ||--o{ indicador_publico_interes : "1:N (indicador)"
    ...
    proyecto ||--o{ proyecto_accion : "1:N (proyecto)"
...
erDiagram
    ...
    usuario ||--|| usuario_tipo_usuario : "tiene rol"
    usuario_tipo_usuario }o--|| tipo_usuario : "referencia"
...
erDiagram
    ...
    actividad ||--o{ ejecucion_actividad : "tiene ejecuciones"
    ejecucion_actividad ||--|| ejecucion_actividad_estado_actividad : "tiene estado"
    ejecucion_actividad ||--o{ registro_asistencia : "tiene asistencias"
```
...
erDiagram
    ...
    indicador ||--|| indicador_tipo_indicador : "tiene tipo"
    indicador ||--|| indicador_temporalidad : "tiene temporalidad"
    indicador ||--|| indicador_proyecto : "tiene proyecto"
    indicador ||--o{ indicador_publico_interes : "tiene públicos"
    indicador_tipo_indicador }o--|| tipo_indicador : "ref."
    indicador_temporalidad }o--|| temporalidad : "ref."
    indicador_proyecto }o--|| proyecto : "ref."
    indicador_publico_interes }o--|| publico_interes : "ref."
    proyecto ||--o{ proyecto_accion : "tiene acciones"
    proyecto_accion }o--|| accion : "ref."
```
...
| Standalone    | Todas las demás (actividad, usuario, indicador, etc.)              | 34          |
| **Total**     |                                                                     | **44**      |
...
| 3     | `TemporalidadDataLoader`       | `temporalidad`         | 5         | Si tabla vacía                    |
...
| Apellidos          | UCO                                         |
| Correo             | administrador@uco.net.co                    |
| Clave              | Administrador123 (almacenada como BCrypt)   |
...
|-------------|---------|------------------------------------------------------------------------------------------------|
| 2026-03-27  | 1.0     | Creación inicial — Modelo de fuente de información con 44 entidades, mapeo backend↔frontend, seed data, ER completo |
