...
| **Versión** | 2.0.0 |
| **Fecha** | 2026-04-27 |
| **Estado** | Actualizado — Post-Dockerización |
| **Autor** | GitHub Copilot — Agente Arquitecto Método Ceiba |
| **Artefacto anterior** | [40. Manual de Operación del Producto](40.manual_de_operacion_del_producto.md) |
...
- ~~`SeguridadConstante.LOCAL_FRONT_URL = "http://localhost:4200"` está hardcoded. En despliegue productivo debe externalizarse a variable de entorno (R-06).~~ **Resuelto en v2.0.** La constante `LOCAL_FRONT_URL` ya no se usa para CORS.
...
|---------|-------|-------|-------------|
| 1.0.0 | 2026-03-27 | GitHub Copilot — Agente PO Ceiba | Creación inicial del Documento Técnico Final como baseline del sistema SIBE v1.0. 18 ADRs, métricas de calidad, inventario de deuda técnica, 12 riesgos arquitectónicos, matriz de trazabilidad ADR↔Driver, y roadmap técnico. |
| 2.0.0 | 2026-04-27 | GitHub Copilot — Agente Arquitecto Ceiba | **Actualización por Dockerización.** Corrección de número de artefacto (era 40, correcto es 41). Sección 3.3 (infraestructura ampliada con Docker, imágenes, volúmenes, variables de entorno). ADR-013 actualizado: CORS ahora parametrizable vía `Environment`; riesgo R-06 resuelto. Nuevo ADR-019: Containerización con Docker y Docker Compose. Matriz de trazabilidad ampliada con ADR-019. |
