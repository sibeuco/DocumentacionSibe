...
| Componente | Tecnología | Build Tool | Puerto |
|------------|-----------|------------|--------|
| Backend | Java 17, Spring Boot 3.5.0 | Gradle 8.x | 8080 |
| Frontend | Angular 16.2, TypeScript 5.1 | Angular CLI 16.2 | 4200 |
| Base de datos | PostgreSQL 15+ | DDL auto (Hibernate) | 5432 |
