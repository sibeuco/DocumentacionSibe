...
| **Proyecto**      | SIBE — Sistema de Bienestar Estudiantil                     |
| **Versión**       | 1.0                                                         |
| **Fecha**         | 2025-07-23                                                  |
| **Autor**         | Equipo de Desarrollo SIBE                                   |
| **Estado**        | Vigente                                                     |
| **Artefacto anterior** | [31. Repositorio de Control de Versiones](31.repositorio_de_control_de_versiones.md) |
| **Artefacto siguiente** | Artefacto 33                                         |
...
- [Artefacto 32 — Pruebas Unitarias y de Integración del Proyecto SIBE](#artefacto-32--pruebas-unitarias-y-de-integración-del-proyecto-sibe)
  ...
  - [7. Pruebas de Componentes y Servicios — Frontend](#7-pruebas-de-componentes-y-servicios--frontend)
    ...
    - [7.3 Guardias de Ruta](#73-guardias-de-ruta)
      ...
      - [`securityGuard` (`security.guard.spec.ts`) — 10 pruebas](#securityguard-securityguardspects--10-pruebas)
...
> **Nota:** La cobertura de código (métricas de líneas, ramas y métodos) se documenta en el **Artefacto 34**. Este artefacto se limita a describir la estructura, organización y comportamiento de las pruebas implementadas.
...
#### `securityGuard` (`security.guard.spec.ts`) — 10 pruebas
| Prueba | Descripción |
|--------|-------------|
...
| `should allow access to gestionar-indicadores when ADMINISTRADOR_AREA` | Acceso a indicadores para área admin |
