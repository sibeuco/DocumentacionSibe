...
| **Organización GitHub** | [sibeuco](https://github.com/sibeuco)                                           |
| **Repositorio Backend** | [sibeuco/sibe-backend](https://github.com/sibeuco/sibe-backend)                 |
| **Repositorio Frontend**| [sibeuco/sibe-frontend](https://github.com/sibeuco/sibe-frontend)               |
...
El proyecto SIBE utiliza **dos repositorios independientes** alojados en GitHub bajo la organización `sibeuco`. Esta separación sigue el principio de responsabilidad única a nivel de repositorio: cada componente (backend y frontend) tiene su propio ciclo de vida, pipeline de construcción, dependencias y equipo de trabajo independiente.

```mermaid
flowchart TB
    ORG["🏢 Organización GitHub\nsibeuco\ngithub.com/sibeuco"]

    BE["📦 sibe-backend\ngithub.com/sibeuco/sibe-backend\nJava 17 · Spring Boot 3.5.0\n256 commits · 2 ramas activas"]
    FE["📦 sibe-frontend\ngithub.com/sibeuco/sibe-frontend\nAngular 16.2 · TypeScript 5.1\n218 commits · 2 ramas activas"]

    ORG --> BE
    ORG --> FE

    subgraph BE_BRANCHES["Ramas Backend"]
        BE_MAIN["main\n(producción)"]
        BE_DEV["develop\n(integración)"]
    end

    subgraph FE_BRANCHES["Ramas Frontend"]
        FE_MAIN["main\n(producción)"]
        FE_DEV["develop\n(integración)"]
    end
    ...
    style ORG fill:#1a1a2e,color:#fff,stroke:#16213e
...
| Campo                        | Valor                                                                      |
|------------------------------|----------------------------------------------------------------------------|
| **URL**                      | [https://github.com/sibeuco/sibe-backend](https://github.com/sibeuco/sibe-backend) |
| **URL de clonado (HTTPS)**   | `https://github.com/sibeuco/sibe-backend.git`                              |
| **Rama principal**           | `main`                                                                     |
...
| Campo                        | Valor                                                                        |
|------------------------------|------------------------------------------------------------------------------|
| **URL**                      | [https://github.com/sibeuco/sibe-frontend](https://github.com/sibeuco/sibe-frontend) |
| **URL de clonado (HTTPS)**   | `https://github.com/sibeuco/sibe-frontend.git`                               |
| **Rama principal**           | `main`                                                                       |
| **Rama de integración**      | `develop`                                                                    |
| **Rama activa actual**       | `develop`                                                                    |
| **HEAD remoto**              | `origin/main`                                                                |
...
timeline
    ...
    section 2025 — Q2
        Mayo 2025 : Carga inicial backend
                  : Carga inicial frontend
    ...
    section 2025 — Q4
        Ago–Oct 2025 : HU-005 Estructura organizacional
                     : HU-006 Proyectos y Acciones
                     : HU-003 Recuperación contraseña
    section 2026 — Q1
        Ene–Mar 2026 : HU-007 Indicadores
                     : HU-008/009 Carga masiva (Excel)
                     : HU-010-013 Ciclo de actividades
                     : HU-014-015 Reportes y Dashboard
...
```ini
[user]
    name  = CEIBA\esteban.colorado
    email = estecogn@suramericana.com.co

[init]
    defaultBranch = main

[core]
    excludesfile = C:\Users\esteban.colorado\Documents\gitignore_global.txt
```
...
# Abrir Pull Request en: https://github.com/sibeuco/sibe-backend/compare
...
|-------------|---------|------------------------------------------------------------------------------------------------|
| 2026-03-27  | 1.0     | Creación inicial — Documentación de los repositorios `sibe-backend` y `sibe-frontend` en GitHub bajo la organización `sibeuco`. 256 + 218 commits registrados, Git Flow con PR #1–#50+. |
