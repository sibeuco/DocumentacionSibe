...
| **Estado**         | Vigente                                                       |
| **Artefacto anterior** | [32. Pruebas Unitarias y de Integración](32.pruebas_unitarias.md) |
| **Artefacto siguiente** | Artefacto 34                                           |
...
> **Nota:** Las métricas de cobertura de código se documentan en el **Artefacto 34**. Este artefacto se limita estrictamente a la calidad del código y la deuda técnica.
...
| **JaCoCo** | ✅ Configurado | Plugin `jacoco` aplicado, genera reportes XML/HTML. Ver Artefacto 34. |
...
| **Karma / Jasmine** | ✅ Configurado | Para pruebas. Ver Artefacto 32. |
